...
We computed 45 association rules, but narrowed down the rules into relevant subsets based on confidence, lift, and support. We created a subset to only include a lift measure of greater than 2, and a confidence measure greater than 0.3, and a subset with support greater than 0.035.
...
When combining all three measures, we found the following 10 “best” associations.
