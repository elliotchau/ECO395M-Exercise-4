...
# ***
# alternate syntax
# pc1 = kmeans(scores[,1:11], 2, nstart=25)
# qplot(scores[,1], scores[,2], color=factor(pc1$cluster), xlab='Component 1', ylab='Component 2')
# ***
# revealing the colors associated for each group (checking work)
qplot(scores[,1], scores[,2], color=wine$color, xlab='Component 1', ylab='Component 2')
# PCA identifies color well
...
# assortment of plots against chemical properties
...
# the plots do not reveal anything meaningful
